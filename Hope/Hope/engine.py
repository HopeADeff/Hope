...
"""
    ...
    parser.add_argument('--nightshade', action='store_true', help='Use Nightshade protection')
    parser.add_argument('--source-concept', default='artwork', help='Source concept (for Nightshade)')
    parser.add_argument('--target-concept', default='noise', help='Target concept (for Nightshade)')
